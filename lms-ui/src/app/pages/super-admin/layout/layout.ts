    ...
    >
      ...
      >
        <div class="h-16 hidden lg:flex items-center px-6 border-b border-white/5 shrink-0">
          ...
          <span class="ml-3 font-black tracking-tighter uppercase text-sm italic"
            >Amatum Lumina</span
          >
        </div>

        <nav class="flex-1 p-4 space-y-1 overflow-y-auto mt-4 lg:mt-0">
          <p class="px-4 text-[10px] font-black text-slate-600 uppercase tracking-[0.2em] mb-4">
            Management
          </p>
      ...
      <div class="flex-1 flex flex-col min-w-0 h-full relative">
        <header
          class="h-16 border-b border-white/5 bg-[#030712]/50 backdrop-blur-xl flex items-center justify-end px-4 lg:px-8 shrink-0 z-40"
        >
          <div class="relative">
            <button
            ...
            >
              <div
                class="size-8 rounded-full bg-linear-to-tr from-indigo-600 to-indigo-400 border border-white/20 flex items-center justify-center text-xs font-black text-white uppercase"
              >
            ...
            @if (isProfileOpen()) {
              ...
              <div
                class="absolute right-0 mt-2 w-60 bg-[#0b1120] border border-white/10 rounded-2xl p-2 shadow-2xl z-20 animate-in fade-in zoom-in duration-200"
              >
          ...
          <div class="fixed inset-0 z-100 flex items-center justify-center p-4">
            ...
            >
              ...
              <p class="text-sm text-slate-400 text-center mb-8 leading-relaxed">
                Are you sure? You'll need to log back in to access the sovereign console.
              </p>
