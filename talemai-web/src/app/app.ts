    ...
    <div class="min-h-screen bg-[#030712] text-slate-100 overflow-x-hidden selection:bg-sky-500/30">
        ...
        <div class="max-w-7xl mx-auto h-20 px-6 sm:px-8 flex items-center justify-between">
          <div class="flex items-center gap-3 group">
            <div class="flex items-baseline gap-2">
              ...
              <span
                class="text-sky-400 text-lg uppercase tracking-widest font-semibold leading-none"
                >Talemai</span
              >
            </div>
          </div>
      ...
      <section class="relative pt-36 md:pt-48 pb-20 md:pb-32 px-6 text-center">
        <div class="max-w-5xl mx-auto relative z-10">
          <div
            class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-xs uppercase tracking-widest font-semibold mb-8"
          >
            <svg
          ...
          <h1
            class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white leading-[1.1]"
          >
          ...
          <p
            class="mt-8 max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-slate-400 leading-relaxed font-normal"
          >
      ...
      <section class="pb-32 px-6 relative z-10">
        <div class="max-w-6xl mx-auto">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
              class="group p-8 rounded-2xl bg-[#0a0f1d] border border-slate-800 flex flex-col hover:border-slate-700 transition-all"
            >
              <div
              ...
              <div
                class="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-indigo-300 font-medium"
              >
            ...
            >
              ...
              <div
                class="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-sky-300 font-medium"
              >
                <span class="inline-flex items-center gap-1.5">
                  <svg
            ...
            >
              ...
              <div
                class="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-emerald-300 font-medium"
              >
                <span class="inline-flex items-center gap-1.5">
                  <svg
            ...
            >
              ...
              <div
                class="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-purple-300 font-medium"
              >
                <span class="inline-flex items-center gap-1.5">
                  <svg
            ...
            >
              ...
              <div
                class="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-pink-300 font-medium"
              >
                <span class="inline-flex items-center gap-1.5">
                  <svg
            ...
            <div
              class="group p-8 rounded-2xl bg-[#0a0f1d] border border-slate-800 flex flex-col justify-center hover:border-slate-700 transition-all"
            >
